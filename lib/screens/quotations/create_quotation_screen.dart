...
class _CreateQuotationScreenState extends State<CreateQuotationScreen> {
  ...
  Future<void> _saveQuotation() async {
    ...
    final quotationId = await _quotationService.addQuotation(quotation);
    ...
    if (mounted) {
      if (quotationId != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Failed to create quotation'),
            backgroundColor: AppColors.error,
          ),
        );
      }
              ...
              Row(
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isSaving ? 'Saving...' : 'Save Quotation'),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: DropdownButtonFormField<double>(
                  ...
                  items: QuotationService.gstPercentages.map((gst) {
                    return DropdownMenuItem(
                      value: gst,
                      child: Text('${gst.toInt()}%'),
                    );
                  }).toList(),
                  onChanged: _quotationType == 'Non-GST'
                      ? null
                      : (value) {

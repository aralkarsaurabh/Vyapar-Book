...
class _EditInvoiceScreenState extends State<EditInvoiceScreen> {
  ...
  Future<void> _loadData() async {
    ...
    if (invoice != null) {
      setState(() {
        ...
        _invoiceType = invoice.invoiceType ?? 'GST';
        _lineItems = invoice.lineItems.isNotEmpty ? invoice.lineItems : [LineItem()];
        _hasDiscount = invoice.hasDiscount;
        _discountType = invoice.discountType ?? 'percentage';
        _discountValueController.text = invoice.discountValue.toString();
  ...
  bool get _isIntraState {
    final companyState = _invoice?.companyDetails?['state'] as String?;
  ...
  Future<void> _saveInvoice() async {
    ...
    _invoice!.customerName = _selectedCustomer!.customerName;
    _invoice!.placeOfSupply = _placeOfSupply;
    _invoice!.invoiceDate = _invoiceDate;
    _invoice!.dueDate = _dueDate;
    _invoice!.invoiceType = _invoiceType;
    _invoice!.lineItems = _lineItems;
    _invoice!.subtotal = _subtotal;
    _invoice!.hasDiscount = _hasDiscount;
    _invoice!.discountType = _discountType;
    _invoice!.discountValue = double.tryParse(_discountValueController.text) ?? 0;
    _invoice!.discountAmount = _discountAmount;
    _invoice!.grandTotal = _grandTotal;
    _invoice!.cgstTotal = _cgstTotal;
    _invoice!.sgstTotal = _sgstTotal;
    _invoice!.igstTotal = _igstTotal;
    _invoice!.taxTotal = _taxTotal;
    _invoice!.notes = _notesController.text.trim();
    _invoice!.termsAndConditions = _termsController.text.trim();
    _invoice!.customerDetails = {
    ...
    final success = await _invoiceService.updateInvoice(_invoice!);
              ...
              Row(
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isSaving ? 'Saving...' : 'Update Invoice'),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            controller: TextEditingController(text: _dateFormat.format(_dueDate)),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: DropdownButtonFormField<double>(
              ...
              items: InvoiceService.gstPercentages.map((gst) => DropdownMenuItem(value: gst, child: Text('${gst.toInt()}%'))).toList(),
              onChanged: _invoiceType == 'Non-GST' ? null : (value) {
